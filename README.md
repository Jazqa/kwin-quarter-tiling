...
## Note
- **Maximizing & Unmaximizing** a window will **UNSHIFT** it to the beginning of the array and **Minimizing & Unminimizing** a window will **PUSH** it to the end of the array.
